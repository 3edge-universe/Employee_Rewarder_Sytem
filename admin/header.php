            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="set.php">
                                <i class="fas fa-shopping-basket"></i>Set Target</a>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-th-large"></i>Employee Management
                                <span class="arrow">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="sales.php">
                                        <i class="fas fa-tasks"></i>Employee Details</a>
                                </li>
                                <li>
                                    <a href="lc.php">
                                        <i class="far fa-id-card"></i>Manage employee</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap2">
							...
							<a class='btn btn-success' href='../register.php'>ADD Employee</a>&nbsp&nbsp&nbsp
                    ...
                    <nav class="navbar-sidebar2">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="sales.php">
                                        <i class="fas fa-tasks"></i>Employee Datails</a>
                                </li>
                                <li>
                                    <a href="lc.php">
                                        <i class="far fa-id-card"></i>Manage Employee</a>
