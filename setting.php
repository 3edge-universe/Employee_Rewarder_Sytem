...
{
	$sql="SELECT `password` FROM `emp_record` WHERE `emp_id`='".$_SESSION['id']."'";
	...
	$sql="UPDATE `emp_record` SET `username`='".$_POST['username']."',`password`='$npsw' WHERE `emp_id`='".$_SESSION['id']."'";
...
$sql="SELECT `username` FROM `emp_record` WHERE `emp_id`='".$_SESSION['id']."'";
$i=mysqli_query($conn,$sql);
while($row = mysqli_fetch_array($i)) 
			{
				$username=$row[0];
					...
					<div class="container-fluid">
						...
						<div class="col-md-12 col-lg-8">
                                ...
                                <div class="form-group">
                                    <label>Emp Id:</label>
                                    <input class="au-input au-input--full" type="text" value="<?php echo $_SESSION['id'];?>" disabled>
                                </div>
								<div class="form-group">
                                    <label>Username</label>
                                    <input class="au-input au-input--full" type="text" name="username" value="<?php echo $username;?>" required>
                                </div>
								<div class="form-group">
