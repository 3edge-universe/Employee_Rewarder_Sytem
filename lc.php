							...
							<div class="au-breadcrumb-content">
								<div class="au-breadcrumb-left">
									...
									<ul class="list-unstyled list-inline au-breadcrumb__list">
										...
										<li class="list-inline-item">Loyal Customer</li>
									</ul>
								</div>
							</div>
						</div>
...
<?php 
	$conn = mysqli_connect("localhost","root","","erm");
	$sql="SELECT distinct(`mobile`),`Name` FROM `order` WHERE `emp_id`='".$_SESSION['id']."'";
	$i=mysqli_query($conn,$sql);
?>				
		<section>
                <div class="section__content section__content--p30">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="recent-report2">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        echo "<td>$row[1]</td>";
										echo "<td>$row[0]</td>";
										$sql2="SELECT count(`order_id`),sum(`price`) FROM `order` WHERE `emp_id`='".$_SESSION['id']."' and `mobile`='$row[0]'";
